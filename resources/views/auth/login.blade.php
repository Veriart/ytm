...
<img alt="Professional healthcare services" class="absolute inset-0 w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDI7vETBVkrI_sy7C-CeTdLOekm1HH6GONxlOSNiLdkwYODQOFUaPt0TQhsfAu6U4ot9O_UtLF1MmYos5SWAu7yJgCiYaMJqpit6wSH-UXghY1LzTBNZ3ETQ86_M4Auq1NUYMC2enELqXxPNN3ESh9xbeUArLRCzIusis2Iw7UpdH-u_teEBJyBRQ9NIGtg-fCVLwD0V6TXWyCykVi_P_IvxNOlVdYkcE7Ft6rYx1A6TTyjzfHB3VRi3Q"/>
<!-- Brand Overlay -->
...
<img alt="PT Yakin Tri Medika Logo" class="h-16 w-auto brightness-0 invert" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA7KM_Up0GTmnyrKwMiTkYb1Qn3xqRtS4G_-UcF9qDorIdMkBUqDnv_yMRV2jXp_e4FH5I4XENUYIv5gTkgeYzk9dKpos5Yq-snPVCQFzsd-uiNLu2hcQARAtK3gGX3rm8HfpZUlTSWrf8twI5nZTuNBKakf2OGXusM3AjCQ4RKDKqx-fyd9H1QwYsYO7pl3B0h-qR052q1DsWbHQtmPPm1i0EUhXo5lQbpwlV0w1OyrdxnNWEh91F_7F1H6Fj-AwinFwk"/>
</div>
<p class="text-body-lg max-w-md opacity-90">Your trusted partner in healthcare solutions, providing professional medical equipment and supplies with integrity and care.</p>
</div>
</div>
<!-- Right Side: Login Container -->
<div class="w-full lg:w-1/2 flex flex-col bg-white">
<!-- Mobile/Small Desktop Header -->
<header class="w-full flex items-center justify-between px-margin-mobile md:px-margin-desktop py-md lg:hidden">
<div class="flex items-center">
<img alt="PT Yakin Tri Medika Logo" class="h-10 w-auto" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCd8lkp-ZgD2JlfM9cGfDDVukc0qvGyTPdq7_UILl435czuMYkgTDRJS1EYBeh6OSDfsUzlED7bUOLl0tDoVfqB6pIq06b3xfJ5t-bNMxHY7DXW1Gept1R5tSFe5fUae-J2xSP8b_9UzlQAYZq5jNcd3x0FndWPDHGhOZs8FF02Mh7e8LEomUQ07D3FxvirKQXGBknN-dTU1kcOJ4yBqY-76Xs_gxfAQxL7RRg0_7T6DWRDna7OodGG1_Sdn8AN1WExd20"/>
</div>
<a class="font-label-md text-label-md text-on-surface-variant hover:text-ytm-teal transition-colors flex items-center gap-base" href="#">
...
<a class="text-caption font-label-md text-ytm-teal hover:underline" href="#">Forgot Password?</a>
</div>
<div class="relative input-focus border border-outline-variant rounded-lg bg-white overflow-hidden transition-all duration-200">
...
<button class="flex items-center justify-center gap-xs py-3 px-sm border border-outline-variant rounded-lg hover:bg-surface-container-low transition-colors font-label-md text-label-md text-on-surface">
<img alt="Google" class="w-5 h-5" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBGWQe9WTN9hCfmegm6JoBCRzmH5jM1ik9HnH2MQS9HTXgJFYD2NKLHCQQVTuarydHQRQ2ctvrN-n4BMPxrhDz9aO0_y_XV07P_gOvHiCk7FbeS1ojpdomBp1LgKDNeagnI8hKawKqJTh-dUcQEHpblyor-dGn_LeTq1UkYb4ChGuVtyGvJ5SjNCxZ8PihrQSMpascfTGOeUflh8-cXH01hfylo11v_5Spy53lQ70IffsFuCWrNpy59cQ"/>
                            Google
                        </button>
<button class="flex items-center justify-center gap-xs py-3 px-sm border border-outline-variant rounded-lg hover:bg-surface-container-low transition-colors font-label-md text-label-md text-on-surface">
<span class="material-symbols-outlined text-lg" style="font-variation-settings: 'FILL' 1;">apps</span>
                            Apple
                        </button>
</div>
<!-- Signup Redirect -->
...
<!-- Footer -->
<footer class="w-full py-lg px-margin-mobile md:px-margin-desktop bg-surface-container-low border-t border-outline-variant">
...
<img alt="PT Yakin Tri Medika Logo" class="h-8 w-auto" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBHg5XNjxdtxQpozx0bIFmdUDg_BhWzPQ2CU5j6fQE4ENSBH1d79SFcg9NguI9KKqctEyVcKZrkHyKN7DWet4CNq8ofoKWgZqAxQesppCwaWjTQ0wctXaPG0B0o3B6QFyuZG6Sh3ss4ZV0PPFJgGmsXir42wobJdfyax0LCTxVfKCv8gVgyZvXXx3jzQvdd9RdX4uQm6UxO-pVVgWGQmz20I7XBlghsMnnewEJqj-UF5afonufAVwaYyTSD_7lbfGNlo7c"/>
</div>
<p class="text-caption font-caption text-on-surface-variant">© 2024 PT Yakin Tri Medika. All rights reserved.</p>
</div>
<div class="flex flex-wrap justify-center gap-lg">
<a class="text-caption font-label-md text-on-surface-variant hover:text-ytm-teal transition-colors" href="#">Medical Licensing</a>
<a class="text-caption font-label-md text-on-surface-variant hover:text-ytm-teal transition-colors" href="#">Distribution Partners</a>
<a class="text-caption font-label-md text-on-surface-variant hover:text-ytm-teal transition-colors" href="#">Privacy Policy</a>
<a class="text-caption font-label-md text-on-surface-variant hover:text-ytm-teal transition-colors" href="#">Terms of Service</a>
</div>
<div class="flex items-center gap-md">
<div class="flex flex-col items-end">
<span class="text-[10px] font-bold text-error bg-error/10 px-2 py-0.5 rounded-full uppercase tracking-widest">Customer Support</span>
