...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'banner_image_1' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:10240',
            ...
            'banner_image_2' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:10240',
            ...
            'banner_image_3' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:10240',
        ...
        if ($request->hasFile('logo')) {
            ...
            if ($oldLogo && ! str_starts_with($oldLogo, 'http') && File::exists(public_path($oldLogo))) {
        ...
        if ($request->hasFile('banner_image_1')) {
            $oldBanner1 = Setting::getValue('banner_image_1');
            if ($oldBanner1 && ! str_starts_with($oldBanner1, 'http') && File::exists(public_path($oldBanner1))) {
                File::delete(public_path($oldBanner1));
            }
        ...
        if ($request->hasFile('banner_image_2')) {
            $oldBanner2 = Setting::getValue('banner_image_2');
            if ($oldBanner2 && ! str_starts_with($oldBanner2, 'http') && File::exists(public_path($oldBanner2))) {
                File::delete(public_path($oldBanner2));
            }
        ...
        if ($request->hasFile('banner_image_3')) {
            $oldBanner3 = Setting::getValue('banner_image_3');
            if ($oldBanner3 && ! str_starts_with($oldBanner3, 'http') && File::exists(public_path($oldBanner3))) {
                File::delete(public_path($oldBanner3));
            }
